...
export default function Actwork({ data }) {
    ...
    return (
        <div>
            ...
            <div className='pdf-center text-center my-5'>
                <h4 className='title-of-pdf'>АКТ ВЫПОЛНЕННЫХ РАБОТ</h4>
            ...
            <div className='pdf-table row'>
                <div className='col-6'>
                    <tbody className='table table-seller'>
                        ...
                        <tr>
                            <td className='w-50'>Идентификационный номер налогоплательщика ИНН/ПИНФЛ:</td>
            ...
            <div className='my-4'>
                <p className='m-0'>{datas.actdoc.acttext}</p>
            </div>
            <div className='my-5'>
